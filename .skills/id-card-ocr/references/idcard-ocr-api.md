...
| third_part_domain | `app-bo4w33bsdqm9-api-k93RZBjP0zqa-gateway.appmiaoda.com` |
...
async function recognizeIdCard(
  ...
  const response = await fetch(
    "https://app-bo4w33bsdqm9-api-k93RZBjP0zqa-gateway.appmiaoda.com/rest/2.0/ocr/v1/idcard",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/x-www-form-urlencoded",
...
- **第三方域名**：实际请求转发至 `app-bo4w33bsdqm9-api-k93RZBjP0zqa-gateway.appmiaoda.com`，网关代理后客户端无需感知。
