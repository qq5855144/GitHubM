...
| 方法 | POST |
| Endpoint | `https://app-bo4w33bsdqm9-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-bo4w33bsdqm9-api-V9gDzg15D7BL-gateway.appmiaoda.com/v1/video_generation", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      "X-Gateway-Authorization": `Bearer ${apiKey}`,
...
| 方法 | GET |
| Endpoint | `https://app-bo4w33bsdqm9-api-zYkZz2eDWvPL-gateway.appmiaoda.com/v1/query/video_generation` |
| 计费 | 不计费 |
...
| 方法 | GET |
| Endpoint | `https://app-bo4w33bsdqm9-api-GYX1ld3ExkQa-gateway.appmiaoda.com/v1/files/retrieve` |
| 计费 | 不计费 |
